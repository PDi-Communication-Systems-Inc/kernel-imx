...
static struct gpio_keys_button ard_buttons[] = {
	...
	GPIO_BUTTON(AR6MX_ANDROID_VOLUP,   KEY_F16,   1, "volume-up",   0), // navigate up
	GPIO_BUTTON(AR6MX_ANDROID_VOLDOWN, KEY_F17, 1, "volume-down", 0),   // navigate down
	GPIO_BUTTON(AR6MX_ANDROID_ARROWLEFT, KEY_F18, 1, "arrow-left", 0),  // select
};
